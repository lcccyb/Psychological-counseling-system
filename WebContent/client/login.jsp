...
<body class="login-layout" style="background-image: url(${pageContext.request.contextPath }/mutualResource/myImg/timg--.jpg);background-size:cover;background-color: #eff5f8;">

    <div class="loginbody">
<div class="login-container">
	<div class="center">
	<h1>
									<span class="black">心理咨询管理系统</span>
								</h1>
							</div>
