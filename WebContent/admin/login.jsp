...
<body class="login-layout" style="background-image: url(${pageContext.request.contextPath }/mutualResource/myImg/pencil2.png);background-size:cover;opacity:0.7">

    <div class="loginbody">
<div class="login-container">
	<div class="center">
	<h1>
									<span class="white">心理咨询管理系统</span>
								</h1>
							</div>
