...
setInterval(function(){
  ...
  $('#Exit_system').on('click', function(index){
	...
	<body>
		<div class="navbar navbar-default" id="navbar" style="background: #006400">
        <script type="text/javascript">
               ...
               <ul class="nav ace-nav">	
                <li class="#006400">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<span  class="time"><em id="time"></em></span><span class="user-info"><small>欢迎,</small>${LOGIN_DOCTOR.name }	</span>
							</a>
