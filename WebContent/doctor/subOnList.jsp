...
<div class="page-content clearfix">
	...
	<c:forEach items="${clientArchiveList }" var="clientArchive">
		...
		<tr>
          ...
          <c:if test="${empty clientArchive.docPath}"> 未上传
          </c:if>
          ...
          <a style="text-decoration:none" class="btn btn-xs btn-success" onclick="finshSub(this,'${clientArchive.archivesId}','${clientArchive.docPath}','${clientArchive.client.clientId}')">完成咨询</a>
          </td>
 ...
 * 完成咨询
 */
function finshSub(obj,archivesId,docPath,clientId,applyTime){
